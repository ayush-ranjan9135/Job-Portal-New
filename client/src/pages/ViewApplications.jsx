            ...
            <tr key={index} className='text-gray-700'>
              ...
              <td className='py-2 px-4 border-b relative'>
                 ...
                 <div className='relative group inline-block text-left'>
                       {/* Trigger button */}
                       <button className='text-gray-500 px-3 py-1 rounded group-hover:bg-gray-100'>
                         ...
                       </button>
                       {/* Dropdown (appears on hover) */}
                       <div className='absolute right-0 z-10 hidden group-hover:block mt-1 w-32 bg-white border border-gray-200 rounded shadow'>
                         <button
